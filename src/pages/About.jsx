      ...
      <div className="hero-content md:gap-12 flex-col lg:flex-row-reverse">
        ...
        <div className="w-3/4">
          ...
          <p className="pb-6 font-lato">
            ...
            explore and build modern, responsive websites, combining creativity
            with functionality.
          </p>
          <p className="pb-6 font-lato">
            Beyond academics and coding, I enjoy spending time exploring new
            technologies, teaching others, and occasionally indulging in hobbies
            like reading or brainstorming creative ideas. These experiences help
            me stay inspired and add unique perspectives to my work.
          </p>
        </div>
      </div>
    </div>
